...
# repita a solicitação se algo diferente for digitado, como um número maior que 20 ou menor
# que zero ou uma letra
...
while True:
    exibirNumero = input('Digite um número de 0 a 20')
    if exibirNumero  
